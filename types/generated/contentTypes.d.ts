...
export interface ApiApplyPageApplyPage extends Schema.SingleType {
  collectionName: 'apply_pages';
  info: {
    singularName: 'apply-page';
    pluralName: 'apply-pages';
    displayName: 'Apply Page';
    description: '';
  };
  options: {
...
export interface ApiFormForm extends Schema.CollectionType {
  ...
  attributes: {
    formName: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'Contact Form'>;
    formFields: Attribute.DynamicZone<
      [
    ...
    >;
    addCaptcha: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    formId: Attribute.UID<'api::form.form', 'formName'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    ...
    footerDisclaimer: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    hero: Attribute.Component<'layout.hero'> & Attribute.Required;
    pageContent: Attribute.DynamicZone<
      ['layout.split-column', 'layout.rich-text', 'layout.testimonials']
    >;
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    pageHero: Attribute.Component<'layout.hero'>;
    pageContent: Attribute.DynamicZone<
      [
        'layout.rich-text',
        'layout.split-column',
...
export interface ApiTestimonialTestimonial extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    testimonialText: Attribute.RichText &
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::apply-page.apply-page': ApiApplyPageApplyPage;
